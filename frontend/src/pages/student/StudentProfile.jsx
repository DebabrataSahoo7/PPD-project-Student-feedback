      ...
      <div className="max-w-xl mx-auto py-8 space-y-8">
        ...
        <section className="flex flex-col items-center justify-center gap-4">
          ...
          <div className="text-center">
            <h2 className="text-3xl font-headline font-extrabold text-on-surface tracking-tight mb-1">{user?.name}</h2>
        ...
        <section className="flex flex-col gap-4">
          ...
          <GlassCard className="p-6">
            <h3 className="font-headline font-bold text-on-surface-variant text-[10px] uppercase tracking-widest mb-4">Personal Details</h3>
            <div className="flex flex-col gap-6">
              ...
              {user?.registration_number && (
                <div>
                  <p className="text-xs text-on-surface-muted mb-1 font-medium">Registration Number</p>
                  <p className="text-base font-semibold text-on-surface">{user.registration_number}</p>
                </div>
              )}
            </div>
          </GlassCard>
          ...
          {/* Account */}
          <GlassCard className="p-6">
            <h3 className="font-headline font-bold text-on-surface-variant text-[10px] uppercase tracking-widest mb-4">Account</h3>
            <div className="flex flex-col gap-6">
              <div>
                ...
                <div className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-primary/10 text-primary border border-primary/20 mt-1">
                  <span className="text-xs font-bold uppercase tracking-wider capitalize">{user?.role}</span>
                </div>
              </div>
            </div>
          </GlassCard>
